...
module Buttons
  class Component < ViewComponent::Base
    ...
    def basic_variant_classes
      case @variant
      when :primary
        "border border-neutral-400/30 bg-neutral-800 text-white shadow-sm hover:bg-neutral-700 focus-visible:outline-neutral-600"
      when :secondary
        "border border-black/10 bg-white/90 text-neutral-800 shadow-xs hover:bg-neutral-50 focus-visible:outline-neutral-600"
      when :outline
        "border border-neutral-300 bg-transparent text-neutral-700 hover:bg-neutral-100 focus-visible:outline-neutral-600"
      when :ghost
        "bg-transparent text-neutral-800 hover:bg-neutral-100 hover:text-neutral-900 focus-visible:outline-neutral-600"
      when :destructive
        "border border-red-300/30 bg-red-600 text-white shadow-sm hover:bg-red-500 focus-visible:outline-neutral-600"
      else
