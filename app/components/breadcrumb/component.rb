...
module Breadcrumb
  class Component < ViewComponent::Base
    ...
    def list_classes
      ...
      bg = @variant == :with_background ? "bg-neutral-50 px-4 py-2 rounded-lg border border-black/10" : ""
    ...
    def link_classes
      ...
      when :with_background
        "text-neutral-600 hover:text-neutral-900 transition-colors font-medium"
      when :with_icons
        "flex items-center text-neutral-500 hover:text-neutral-700 transition-colors p-1.5 rounded hover:bg-neutral-100"
      else
    ...
    def current_classes
      ...
      base = "text-neutral-900 #{base_weight}"
